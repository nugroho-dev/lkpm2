                ...
                <div class="col-xl-12">
                  ...
                  <div class="card mb-4">
                    <h5 class="card-header">
                      <div class="demo-inline-spacing text-start">
                      Lihat Laporan
                      </div>
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-12">
                          <form method="post" action="/proyek/laporan" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card shadow-none bg-transparent border border-secondary mb-3">
                              <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-2">
                                    <select class="form-select @error('tahun') is-invalid @enderror" id="exampleFormControlSelect1" aria-label="Default select example" name="tahun" disabled>
                                      {{ $last= date('Y')-1 }}
                                      {{ $now = date('Y') }}
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-3">
                                    <select class="form-select @error('periode') is-invalid @enderror" id="exampleFormControlSelect1" aria-label="Default select example" name="periode" disabled>
                            ...
                            <div class="card shadow-none bg-transparent border border-secondary mb-3">
                              <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-4">
                                    <input class="form-control @error('modal_tetap') is-invalid @enderror" type="number" value="{{ $post->modal_tetap }}"  placeholder="Contoh : 25000000" id="html5-email-input" name="modal_tetap" readonly/>
                                    @error ('modal_tetap')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-4">
                                    <input class="form-control @error('modal_kerja') is-invalid @enderror" type="number" value="{{ $post->modal_kerja }}" placeholder="Contoh : 25000000" id="html5-email-input" name="modal_kerja" readonly/>
                                    @error ('modal_kerja')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-8">
                                    <textarea class="form-control @error('keterangan') is-invalid @enderror" id="exampleFormControlTextarea1" rows="3" placeholder="Isi Dengan Keterangan dari Modal Kerja dan Modal Tetap " name="keterangan" readonly>{{$post->keterangan }}</textarea>
                                    @error ('keterangan')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-3">
                                    <input class="form-control @error('produksi') is-invalid @enderror" type="number" value="{{$post->produksi }}" placeholder="Contoh : 25000"id="html5-password-input" name="produksi" readonly/>
                                    @error ('produksi')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-3">
                                    <input class="form-control @error('ekspor') is-invalid @enderror" type="number" value="{{ $post->ekspor }}" placeholder="Contoh : 25000" id="html5-number-input" name="ekspor" readonly/>
                                    @error ('ekspor')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-8">
                                    <input class="form-control @error('kemitraan') is-invalid @enderror" type="text" value="{{ $post->kemitraan }}" id="html5-month-input" placeholder="Isi Dengan Kemitraan" name="kemitraan" readonly/>
                                    @error ('kemitraan')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
                            ...
                            <div class="card shadow-none bg-transparent border border-secondary mb-3">
                              <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-2">
                                    <input class="form-control @error('tki_p') is-invalid @enderror" type="number" value="{{ $post->tki_p }}"  placeholder="Contoh : 25"id="html5-tel-input" name="tki_p" readonly/>
                                    @error ('tki_p')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
                            ...
                            <div class="card shadow-none bg-transparent border border-secondary mb-3">
                              <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-8">
                                    <select class="form-select @error('kategori_masalah') is-invalid @enderror" id="exampleFormControlSelect1" aria-label="Default select example" name="kategori_masalah" disabled>
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-8">
                                    <textarea class="form-control @error('permasalahan') is-invalid @enderror" id="exampleFormControlTextarea1" rows="3" placeholder="Isi Dengan Permasalahan Yang Sedang Dihadapai" name="permasalahan" readonly>{{ $post->permasalahan }}</textarea>
                                    @error ('permasalahan')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
                            ...
                            <div class="card shadow-none bg-transparent border border-secondary mb-3">
                              <div class="card-body">
                                <div class="divider divider-dashed">
                                  <div class="divider-texth-6" readonly><h6>Pimpinan / Penanggung Jawab LKPM</h6></div>
                                </div>
                                <div class="mb-3 row">
                                  <label for="html5-month-input" class="col-md-3 col-form-label">Nama Petugas</label>
                                  <div class="col-md-8">
                                    <input class="form-control @error('nama_pegawai') is-invalid @enderror" type="text" value="{{ $post->nama_pegawai }}" id="html5-month-input" placeholder="Isi Dengan Petugas Pengisi Data Laporan"  name="nama_pegawai" readonly/>
                                    @error ('nama_pegawai')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-8">
                                    <input class="form-control @error('jabatan') is-invalid @enderror" type="text" value="{{ $post->jabatan }}" id="html5-month-input"  placeholder="Isi Dengan Jabatan Petugas Pengisi Data Laporan" name="jabatan" readonly/>
                                    @error ('jabatan')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-8">
                                    <input class="form-control @error('no_hp') is-invalid @enderror" type="tel" value="{{ $post->no_hp }}" id="html5-month-input"  placeholder="Isi Dengan No HP Petugas Pengisi Data Laporan" name="no_hp" readonly/>
                                    @error ('no_hp')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-8">
                                    <input class="form-control @error('email') is-invalid @enderror" type="email" value="{{ $post->email }}" id="html5-month-input"  placeholder="Isi Dengan Email Petugas Pengisi Data Laporan" name="email" readonly/>
                                    @error ('email')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
              ...
              <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel2">Hapus Laporan</h5>
                    <button
                      type="button"
                      class="btn-close"
