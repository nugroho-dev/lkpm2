            ...
            <div class="container-fluid flex-grow-1 container-p-y">
              ...
              <div class="row">
                <div class="col-xl-12">
                  <!-- HTML5 Inputs -->
                  <div class="card mb-4">
                    <h5 class="card-header">Buat Laporan</h5>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-12">
                          <form method="post" action="{{ url('/proyek/laporan') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card shadow-none bg-transparent border border-secondary mb-3">
                              <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-4">
                                    <input class="form-control @error('modal_tetap') is-invalid @enderror" type="number" value="{{ old('modal_tetap') }}"  placeholder="Contoh : 25000000" id="html5-email-input" name="modal_tetap" />
                                    @error ('modal_tetap')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-4">
                                    <input class="form-control @error('modal_kerja') is-invalid @enderror" type="number" value="{{ old('modal_kerja') }}" placeholder="Contoh : 25000000" id="html5-email-input" name="modal_kerja" />
                                    @error ('modal_kerja')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-8">
                                    <textarea class="form-control @error('keterangan') is-invalid @enderror" id="exampleFormControlTextarea1" rows="3" placeholder="Isi Dengan Keterangan dari Modal Kerja dan Modal Tetap " name="keterangan">{{ old('keterangan') }}</textarea>
                                    @error ('keterangan')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-3">
                                    <input class="form-control @error('produksi') is-invalid @enderror" type="number" value="{{ old('produksi') }}" placeholder="Contoh : 25000"id="html5-password-input" name="produksi"/>
                                    @error ('produksi')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-3">
                                    <input class="form-control @error('ekspor') is-invalid @enderror" type="number" value="{{ old('ekspor') }}" placeholder="Contoh : 25000" id="html5-number-input" name="ekspor" />
                                    @error ('ekspor')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-8">
                                    <input class="form-control @error('kemitraan') is-invalid @enderror" type="text" value="{{ old('kemitraan') }}" id="html5-month-input" placeholder="Isi Dengan Kemitraan" name="kemitraan"/>
                                    @error ('kemitraan')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
                            ...
                            <div class="card shadow-none bg-transparent border border-secondary mb-3">
                              <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-2">
                                    <input class="form-control @error('tki_p') is-invalid @enderror" type="number" value="{{ old('tki_p') }}"  placeholder="Contoh : 25"id="html5-tel-input" name="tki_p" />
                                    @error ('tki_p')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
                            ...
                            <div class="card shadow-none bg-transparent border border-secondary mb-3">
                              <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-8">
                                    <textarea class="form-control @error('permasalahan') is-invalid @enderror" id="exampleFormControlTextarea1" rows="3" placeholder="Isi Dengan Permasalahan Yang Sedang Dihadapai" name="permasalahan">{{ old('permasalahan') }}</textarea>
                                    @error ('permasalahan')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
                            ...
                            <div class="card shadow-none bg-transparent border border-secondary mb-3">
                              <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-8">
                                    <input class="form-control @error('nama_pegawai') is-invalid @enderror" type="text" value="{{ old('nama_pegawai') }}" id="html5-month-input" placeholder="Isi Dengan Petugas Pengisi Data Laporan"  name="nama_pegawai"/>
                                    @error ('nama_pegawai')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-8">
                                    <input class="form-control @error('jabatan') is-invalid @enderror" type="text" value="{{ old('jabatan') }}" id="html5-month-input"  placeholder="Isi Dengan Jabatan Petugas Pengisi Data Laporan" name="jabatan" />
                                    @error ('jabatan')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-8">
                                    <input class="form-control @error('no_hp') is-invalid @enderror" type="tel" value="{{ old('no_hp') }}" id="html5-month-input"  placeholder="Isi Dengan No HP Petugas Pengisi Data Laporan" name="no_hp" />
                                    @error ('no_hp')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
                                ...
                                <div class="mb-3 row">
                                  ...
                                  <div class="col-md-8">
                                    <input class="form-control @error('email') is-invalid @enderror" type="email" value="{{ old('email') }}" id="html5-month-input"  placeholder="Isi Dengan Email Petugas Pengisi Data Laporan" name="email"/>
                                    @error ('email')
                                    <div id="defaultFormControlHelp" class="form-text text-danger">
                                       {{ $message }} 
                                    </div>
